        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                using (IServiceScope serviceScope = serviceScopeFactory.CreateScope())
                {
                    ...
                    ISendReadEmailService sendReadEmailService = serviceProvider.GetRequiredService<ISendReadEmailService>();
                    ...
                    var emailList = await sendReadEmailService.GetAllEmailMessagesAsync();
